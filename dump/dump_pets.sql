...
CREATE TABLE public.card (
    ...
    donated_amount character varying DEFAULT 0
);
...
INSERT INTO public.card (id, pet_name, pet_type_id, date_birth, castrated, vaccinated, cat_litter_box, description, counter_views, donated_amount) VALUES (1, 'Малыш Поребрик ', 1, '2024-03-23', false, false, true, 'не знаю что писать', 0, '0');
